...
import my_python_bindings.enumerations
...
class CursorKind(BaseEnumeration):
    ...
    def __init__(self, value, given_name='Kurt'):
        super(CursorKind, self).__init__(value)
        self.name = given_name

    def baptize(given_name):
        name = given_name
...
# reported.
CursorKind.UNEXPOSED_DECL = CursorKind(1, 'Unexposed_Decl')
CursorKind.FIRST_DECL = CursorKind.UNEXPOSED_DECL
# A C or C++ struct.
CursorKind.STRUCT_DECL = CursorKind(2,'Struct_Decl')

# A C or C++ union.
CursorKind.UNION_DECL = CursorKind(3, 'Union_Decl')

# A C++ class.
CursorKind.CLASS_DECL = CursorKind(4, 'Class_Decl')

# An enumeration.
CursorKind.ENUM_DECL = CursorKind(5, 'Enum_Decl')

# A field (in C) or non-static data member (in C++) in a struct, union, or C++
# class.
CursorKind.FIELD_DECL = CursorKind(6, 'Field_Decl')

# An enumerator constant.
CursorKind.ENUM_CONSTANT_DECL = CursorKind(7, 'Enum_Constant_Decl')

# A function.
CursorKind.FUNCTION_DECL = CursorKind(8, 'Function_Decl')

# A variable.
CursorKind.VAR_DECL = CursorKind(9, 'Var_Decl')

# A function or method parameter.
CursorKind.PARM_DECL = CursorKind(10, 'Parm_Decl')

# An Objective-C @interface.
CursorKind.OBJC_INTERFACE_DECL = CursorKind(11, 'Objc_Interface_Decl')

# An Objective-C @interface for a category.
CursorKind.OBJC_CATEGORY_DECL = CursorKind(12, 'Objc_Category_Decl')

# An Objective-C @protocol declaration.
CursorKind.OBJC_PROTOCOL_DECL = CursorKind(13, 'Objc_Protocol_Decl')

# An Objective-C @property declaration.
CursorKind.OBJC_PROPERTY_DECL = CursorKind(14, 'Objc_Property_Decl')

# An Objective-C instance variable.
CursorKind.OBJC_IVAR_DECL = CursorKind(15, 'Objc_Ivar_Decl')

# An Objective-C instance method.
CursorKind.OBJC_INSTANCE_METHOD_DECL = CursorKind(16, 'Objc_Instance_Method_Decl')

# An Objective-C class method.
CursorKind.OBJC_CLASS_METHOD_DECL = CursorKind(17, 'Objc_Class_Method_Decl')

# An Objective-C @implementation.
CursorKind.OBJC_IMPLEMENTATION_DECL = CursorKind(18, 'Objc_Implementation_Decl')

# An Objective-C @implementation for a category.
CursorKind.OBJC_CATEGORY_IMPL_DECL = CursorKind(19, 'Objc_Category_Impl_Decl')

# A typedef.
CursorKind.TYPEDEF_DECL = CursorKind(20, 'Typedef_Decl')

# A C++ class method.
CursorKind.CXX_METHOD = CursorKind(21, 'Cxx_Method')

# A C++ namespace.
CursorKind.NAMESPACE = CursorKind(22, 'Namespace')

# A linkage specification, e.g. 'extern "C"'.
CursorKind.LINKAGE_SPEC = CursorKind(23, 'Linkage_Spec')

# A C++ constructor.
CursorKind.CONSTRUCTOR = CursorKind(24, 'Constructor')

# A C++ destructor.
CursorKind.DESTRUCTOR = CursorKind(25, 'Destructor')

# A C++ conversion function.
CursorKind.CONVERSION_FUNCTION = CursorKind(26, 'Conversion_Function')

# A C++ template type parameter
CursorKind.TEMPLATE_TYPE_PARAMETER = CursorKind(27, 'Template_Type_Parameter')

# A C++ non-type template parameter.
CursorKind.TEMPLATE_NON_TYPE_PARAMETER = CursorKind(28, 'Template_Non_Type_Parameter')

# A C++ template template parameter.
CursorKind.TEMPLATE_TEMPLATE_PARAMETER = CursorKind(29, 'Template_Template_Parameter')

# A C++ function template.
CursorKind.FUNCTION_TEMPLATE = CursorKind(30, 'Function_Template')

# A C++ class template.
CursorKind.CLASS_TEMPLATE = CursorKind(31, 'Class_Template')

# A C++ class template partial specialization.
CursorKind.CLASS_TEMPLATE_PARTIAL_SPECIALIZATION = CursorKind(32, 'Class_Template_Partial_Specialization')

# A C++ namespace alias declaration.
CursorKind.NAMESPACE_ALIAS = CursorKind(33, 'Namespace_Alias')

# A C++ using directive
CursorKind.USING_DIRECTIVE = CursorKind(34, 'Using_Directive')

# A C++ using declaration
CursorKind.USING_DECLARATION = CursorKind(35, 'Using_Declaration')

# A Type alias decl.
CursorKind.TYPE_ALIAS_DECL = CursorKind(36, 'Type_Alias_Decl')

# A Objective-C synthesize decl
CursorKind.OBJC_SYNTHESIZE_DECL = CursorKind(37, 'Objc_Synthesize_Decl')

# A Objective-C dynamic decl
CursorKind.OBJC_DYNAMIC_DECL = CursorKind(38, 'Objc_Dynamic_Decl')

# A C++ access specifier decl.
CursorKind.CXX_ACCESS_SPEC_DECL = CursorKind(39, 'Cxx_Access_Spec_Decl')


###
# Reference Kinds

CursorKind.OBJC_SUPER_CLASS_REF = CursorKind(40, 'Objc_Super_Class_Ref')
CursorKind.FIRST_REF = CursorKind.OBJC_SUPER_CLASS_REF
CursorKind.OBJC_PROTOCOL_REF = CursorKind(41, 'Objc_Protocol_Ref')
CursorKind.OBJC_CLASS_REF = CursorKind(42, 'Objc_Class_Ref')
...
CursorKind.TYPE_REF = CursorKind(43, 'Type_Ref')
CursorKind.CXX_BASE_SPECIFIER = CursorKind(44, 'Cxx_Base_Specifier')

# A reference to a class template, function template, template
# template parameter, or class template partial specialization.
CursorKind.TEMPLATE_REF = CursorKind(45, 'Template_Ref')

# A reference to a namespace or namepsace alias.
CursorKind.NAMESPACE_REF = CursorKind(46, 'Namespace_Ref')

# A reference to a member of a struct, union, or class that occurs in
# some non-expression context, e.g., a designated initializer.
CursorKind.MEMBER_REF = CursorKind(47, 'Member_Ref')

# A reference to a labeled statement.
CursorKind.LABEL_REF = CursorKind(48, 'Label_Ref')

# A reference to a set of overloaded functions or function templates
# that has not yet been resolved to a specific function or function template.
CursorKind.OVERLOADED_DECL_REF = CursorKind(49, 'Overloaded_Decl_Ref')

# A reference to a variable that occurs in some non-expression
# context, e.g., a C++ lambda capture list.
CursorKind.VARIABLE_REF = CursorKind(50, 'Variable_Ref')
CursorKind.LAST_REF = CursorKind.VARIABLE_REF

###
# Invalid/Error Kinds

CursorKind.INVALID_FILE = CursorKind(70, 'Invalid_File')
CursorKind.NO_DECL_FOUND = CursorKind(71, 'No_Decl_Found')
CursorKind.NOT_IMPLEMENTED = CursorKind(72, 'Not_Implemented')
CursorKind.INVALID_CODE = CursorKind(73, 'Invalid_Code')
...
CursorKind.UNEXPOSED_EXPR = CursorKind(100, 'Unexposed_Expr')

# An expression that refers to some value declaration, such as a function,
# variable, or enumerator.
CursorKind.DECL_REF_EXPR = CursorKind(101, 'Decl_Ref_Expr')

# An expression that refers to a member of a struct, union, class, Objective-C
# class, etc.
CursorKind.MEMBER_REF_EXPR = CursorKind(102, 'Member_Ref_Expr')

# An expression that calls a function.
CursorKind.CALL_EXPR = CursorKind(103, 'Call_Expr')

# An expression that sends a message to an Objective-C object or class.
CursorKind.OBJC_MESSAGE_EXPR = CursorKind(104, 'Objc_Message_Expr')

# An expression that represents a block literal.
CursorKind.BLOCK_EXPR = CursorKind(105, 'Block_Expr')

# An integer literal.
CursorKind.INTEGER_LITERAL = CursorKind(106, 'Integer_Literal')

# A floating point number literal.
CursorKind.FLOATING_LITERAL = CursorKind(107, 'Floating_Literal')

# An imaginary number literal.
CursorKind.IMAGINARY_LITERAL = CursorKind(108, 'Imaginary_Literal')

# A string literal.
CursorKind.STRING_LITERAL = CursorKind(109, 'String_Literal')

# A character literal.
CursorKind.CHARACTER_LITERAL = CursorKind(110, 'Character_Literal')

# A parenthesized expression, e.g. "(1)".
#
# This AST node is only formed if full location information is requested.
CursorKind.PAREN_EXPR = CursorKind(111, 'Paren_Expr')

# This represents the unary-expression's (except sizeof and
# alignof).
CursorKind.UNARY_OPERATOR = CursorKind(112, 'Unary_Operator')

# [C99 6.5.2.1] Array Subscripting.
CursorKind.ARRAY_SUBSCRIPT_EXPR = CursorKind(113, 'Array_Subscript_Expr')

# A builtin binary operation expression such as "x + y" or
# "x <= y".
CursorKind.BINARY_OPERATOR = CursorKind(114, 'Binary_Operator')

# Compound assignment such as "+=".
CursorKind.COMPOUND_ASSIGNMENT_OPERATOR = CursorKind(115, 'Compound_Assignment_Operator')

# The ?: ternary operator.
CursorKind.CONDITIONAL_OPERATOR = CursorKind(116, 'Conditional_Operator')

# An explicit cast in C (C99 6.5.4) or a C-style cast in C++
# (C++ [expr.cast]), which uses the syntax (Type)expr.
#
# For example: (int)f.
CursorKind.CSTYLE_CAST_EXPR = CursorKind(117, 'Cstyle_Cast_Expr')

# [C99 6.5.2.5]
CursorKind.COMPOUND_LITERAL_EXPR = CursorKind(118, 'Compound_Literal_Expr')

# Describes an C or C++ initializer list.
CursorKind.INIT_LIST_EXPR = CursorKind(119, 'Init_List_Expr')

# The GNU address of label extension, representing &&label.
CursorKind.ADDR_LABEL_EXPR = CursorKind(120, 'Addr_Label_Expr')

# This is the GNU Statement Expression extension: ({int X=4; X;})
CursorKind.StmtExpr = CursorKind(121, 'Stmtexpr')

# Represents a C11 generic selection.
CursorKind.GENERIC_SELECTION_EXPR = CursorKind(122, 'Generic_Selection_Expr')
...
CursorKind.GNU_NULL_EXPR = CursorKind(123, 'Gnu_Null_Expr')

# C++'s static_cast<> expression.
CursorKind.CXX_STATIC_CAST_EXPR = CursorKind(124, 'Cxx_Static_Cast_Expr')

# C++'s dynamic_cast<> expression.
CursorKind.CXX_DYNAMIC_CAST_EXPR = CursorKind(125, 'Cxx_Dynamic_Cast_Expr')

# C++'s reinterpret_cast<> expression.
CursorKind.CXX_REINTERPRET_CAST_EXPR = CursorKind(126, 'Cxx_Reinterpret_Cast_Expr')

# C++'s const_cast<> expression.
CursorKind.CXX_CONST_CAST_EXPR = CursorKind(127, 'Cxx_Const_Cast_Expr')
...
#   x = int(0.5);
# \endcode
CursorKind.CXX_FUNCTIONAL_CAST_EXPR = CursorKind(128, 'Cxx_Functional_Cast_Expr')

# A C++ typeid expression (C++ [expr.typeid]).
CursorKind.CXX_TYPEID_EXPR = CursorKind(129, 'Cxx_Typeid_Expr')

# [C++ 2.13.5] C++ Boolean Literal.
CursorKind.CXX_BOOL_LITERAL_EXPR = CursorKind(130, 'Cxx_Bool_Literal_Expr')

# [C++0x 2.14.7] C++ Pointer Literal.
CursorKind.CXX_NULL_PTR_LITERAL_EXPR = CursorKind(131, 'Cxx_Null_Ptr_Literal_Expr')

# Represents the "this" expression in C++
CursorKind.CXX_THIS_EXPR = CursorKind(132, 'Cxx_This_Expr')

# [C++ 15] C++ Throw Expression.
#
# This handles 'throw' and 'throw' assignment-expression. When
# assignment-expression isn't present, Op will be null.
CursorKind.CXX_THROW_EXPR = CursorKind(133, 'Cxx_Throw_Expr')

# A new expression for memory allocation and constructor calls, e.g:
# "new CXXNewExpr(foo)".
CursorKind.CXX_NEW_EXPR = CursorKind(134, 'Cxx_New_Expr')

# A delete expression for memory deallocation and destructor calls,
# e.g. "delete[] pArray".
CursorKind.CXX_DELETE_EXPR = CursorKind(135, 'Cxx_Delete_Expr')

# Represents a unary expression.
CursorKind.CXX_UNARY_EXPR = CursorKind(136, 'Cxx_Unary_Expr')

# ObjCStringLiteral, used for Objective-C string literals i.e. "foo".
CursorKind.OBJC_STRING_LITERAL = CursorKind(137, 'Objc_String_Literal')

# ObjCEncodeExpr, used for in Objective-C.
CursorKind.OBJC_ENCODE_EXPR = CursorKind(138, 'Objc_Encode_Expr')

# ObjCSelectorExpr used for in Objective-C.
CursorKind.OBJC_SELECTOR_EXPR = CursorKind(139, 'Objc_Selector_Expr')

# Objective-C's protocol expression.
CursorKind.OBJC_PROTOCOL_EXPR = CursorKind(140, 'Objc_Protocol_Expr')
...
# \endcode
CursorKind.OBJC_BRIDGE_CAST_EXPR = CursorKind(141, 'Objc_Bridge_Cast_Expr')
...
CursorKind.PACK_EXPANSION_EXPR = CursorKind(142, 'Pack_Expansion_Expr')

# Represents an expression that computes the length of a parameter
# pack.
CursorKind.SIZE_OF_PACK_EXPR = CursorKind(143, 'Size_Of_Pack_Expr')
...
#  }
#  \endcode
CursorKind.LAMBDA_EXPR = CursorKind(144, 'Lambda_Expr')

# Objective-c Boolean Literal.
CursorKind.OBJ_BOOL_LITERAL_EXPR = CursorKind(145, 'Obj_Bool_Literal_Expr')

# Represents the "self" expression in a ObjC method.
CursorKind.OBJ_SELF_EXPR = CursorKind(146, 'Obj_Self_Expr')

# OpenMP 4.0 [2.4, Array Section].
CursorKind.OMP_ARRAY_SECTION_EXPR = CursorKind(147, 'Omp_Array_Section_Expr')

# Represents an @available(...) check.
CursorKind.OBJC_AVAILABILITY_CHECK_EXPR = CursorKind(148, 'Objc_Availability_Check_Expr')
...
CursorKind.UNEXPOSED_STMT = CursorKind(200, 'Unexposed_Stmt')

# A labelled statement in a function.
CursorKind.LABEL_STMT = CursorKind(201, 'Label_Stmt')

# A compound statement
CursorKind.COMPOUND_STMT = CursorKind(202, 'Compound_Stmt')

# A case statement.
CursorKind.CASE_STMT = CursorKind(203, 'Case_Stmt')

# A default statement.
CursorKind.DEFAULT_STMT = CursorKind(204, 'Default_Stmt')

# An if statement.
CursorKind.IF_STMT = CursorKind(205, 'If_Stmt')

# A switch statement.
CursorKind.SWITCH_STMT = CursorKind(206, 'Switch_Stmt')

# A while statement.
CursorKind.WHILE_STMT = CursorKind(207, 'While_Stmt')

# A do statement.
CursorKind.DO_STMT = CursorKind(208, 'Do_Stmt')

# A for statement.
CursorKind.FOR_STMT = CursorKind(209, 'For_Stmt')

# A goto statement.
CursorKind.GOTO_STMT = CursorKind(210, 'Goto_Stmt')

# An indirect goto statement.
CursorKind.INDIRECT_GOTO_STMT = CursorKind(211, 'Indirect_Goto_Stmt')

# A continue statement.
CursorKind.CONTINUE_STMT = CursorKind(212, 'Continue_Stmt')

# A break statement.
CursorKind.BREAK_STMT = CursorKind(213, 'Break_Stmt')

# A return statement.
CursorKind.RETURN_STMT = CursorKind(214, 'Return_Stmt')

# A GNU-style inline assembler statement.
CursorKind.ASM_STMT = CursorKind(215, 'Asm_Stmt')

# Objective-C's overall @try-@catch-@finally statement.
CursorKind.OBJC_AT_TRY_STMT = CursorKind(216, 'Objc_At_Try_Stmt')

# Objective-C's @catch statement.
CursorKind.OBJC_AT_CATCH_STMT = CursorKind(217, 'Objc_At_Catch_Stmt')

# Objective-C's @finally statement.
CursorKind.OBJC_AT_FINALLY_STMT = CursorKind(218, 'Objc_At_Finally_Stmt')

# Objective-C's @throw statement.
CursorKind.OBJC_AT_THROW_STMT = CursorKind(219, 'Objc_At_Throw_Stmt')

# Objective-C's @synchronized statement.
CursorKind.OBJC_AT_SYNCHRONIZED_STMT = CursorKind(220, 'Objc_At_Synchronized_Stmt')

# Objective-C's autorealease pool statement.
CursorKind.OBJC_AUTORELEASE_POOL_STMT = CursorKind(221, 'Objc_Autorelease_Pool_Stmt')

# Objective-C's for collection statement.
CursorKind.OBJC_FOR_COLLECTION_STMT = CursorKind(222, 'Objc_For_Collection_Stmt')

# C++'s catch statement.
CursorKind.CXX_CATCH_STMT = CursorKind(223, 'Cxx_Catch_Stmt')

# C++'s try statement.
CursorKind.CXX_TRY_STMT = CursorKind(224, 'Cxx_Try_Stmt')

# C++'s for (* : *) statement.
CursorKind.CXX_FOR_RANGE_STMT = CursorKind(225, 'Cxx_For_Range_Stmt')

# Windows Structured Exception Handling's try statement.
CursorKind.SEH_TRY_STMT = CursorKind(226, 'Seh_Try_Stmt')

# Windows Structured Exception Handling's except statement.
CursorKind.SEH_EXCEPT_STMT = CursorKind(227, 'Seh_Except_Stmt')

# Windows Structured Exception Handling's finally statement.
CursorKind.SEH_FINALLY_STMT = CursorKind(228, 'Seh_Finally_Stmt')

# A MS inline assembly statement extension.
CursorKind.MS_ASM_STMT = CursorKind(229, 'Ms_Asm_Stmt')

# The null statement.
CursorKind.NULL_STMT = CursorKind(230, 'Null_Stmt')

# Adaptor class for mixing declarations with statements and expressions.
CursorKind.DECL_STMT = CursorKind(231, 'Decl_Stmt')

# OpenMP parallel directive.
CursorKind.OMP_PARALLEL_DIRECTIVE = CursorKind(232, 'Omp_Parallel_Directive')

# OpenMP SIMD directive.
CursorKind.OMP_SIMD_DIRECTIVE = CursorKind(233, 'Omp_Simd_Directive')

# OpenMP for directive.
CursorKind.OMP_FOR_DIRECTIVE = CursorKind(234, 'Omp_For_Directive')

# OpenMP sections directive.
CursorKind.OMP_SECTIONS_DIRECTIVE = CursorKind(235, 'Omp_Sections_Directive')

# OpenMP section directive.
CursorKind.OMP_SECTION_DIRECTIVE = CursorKind(236, 'Omp_Section_Directive')

# OpenMP single directive.
CursorKind.OMP_SINGLE_DIRECTIVE = CursorKind(237, 'Omp_Single_Directive')

# OpenMP parallel for directive.
CursorKind.OMP_PARALLEL_FOR_DIRECTIVE = CursorKind(238, 'Omp_Parallel_For_Directive')

# OpenMP parallel sections directive.
CursorKind.OMP_PARALLEL_SECTIONS_DIRECTIVE = CursorKind(239, 'Omp_Parallel_Sections_Directive')

# OpenMP task directive.
CursorKind.OMP_TASK_DIRECTIVE = CursorKind(240, 'Omp_Task_Directive')

# OpenMP master directive.
CursorKind.OMP_MASTER_DIRECTIVE = CursorKind(241, 'Omp_Master_Directive')

# OpenMP critical directive.
CursorKind.OMP_CRITICAL_DIRECTIVE = CursorKind(242, 'Omp_Critical_Directive')

# OpenMP taskyield directive.
CursorKind.OMP_TASKYIELD_DIRECTIVE = CursorKind(243, 'Omp_Taskyield_Directive')

# OpenMP barrier directive.
CursorKind.OMP_BARRIER_DIRECTIVE = CursorKind(244, 'Omp_Barrier_Directive')

# OpenMP taskwait directive.
CursorKind.OMP_TASKWAIT_DIRECTIVE = CursorKind(245, 'Omp_Taskwait_Directive')

# OpenMP flush directive.
CursorKind.OMP_FLUSH_DIRECTIVE = CursorKind(246, 'Omp_Flush_Directive')

# Windows Structured Exception Handling's leave statement.
CursorKind.SEH_LEAVE_STMT = CursorKind(247, 'Seh_Leave_Stmt')

# OpenMP ordered directive.
CursorKind.OMP_ORDERED_DIRECTIVE = CursorKind(248, 'Omp_Ordered_Directive')

# OpenMP atomic directive.
CursorKind.OMP_ATOMIC_DIRECTIVE = CursorKind(249, 'Omp_Atomic_Directive')

# OpenMP for SIMD directive.
CursorKind.OMP_FOR_SIMD_DIRECTIVE = CursorKind(250, 'Omp_For_Simd_Directive')

# OpenMP parallel for SIMD directive.
CursorKind.OMP_PARALLELFORSIMD_DIRECTIVE = CursorKind(251, 'Omp_Parallelforsimd_Directive')

# OpenMP target directive.
CursorKind.OMP_TARGET_DIRECTIVE = CursorKind(252, 'Omp_Target_Directive')

# OpenMP teams directive.
CursorKind.OMP_TEAMS_DIRECTIVE = CursorKind(253, 'Omp_Teams_Directive')

# OpenMP taskgroup directive.
CursorKind.OMP_TASKGROUP_DIRECTIVE = CursorKind(254, 'Omp_Taskgroup_Directive')

# OpenMP cancellation point directive.
CursorKind.OMP_CANCELLATION_POINT_DIRECTIVE = CursorKind(255, 'Omp_Cancellation_Point_Directive')

# OpenMP cancel directive.
CursorKind.OMP_CANCEL_DIRECTIVE = CursorKind(256, 'Omp_Cancel_Directive')

# OpenMP target data directive.
CursorKind.OMP_TARGET_DATA_DIRECTIVE = CursorKind(257, 'Omp_Target_Data_Directive')

# OpenMP taskloop directive.
CursorKind.OMP_TASK_LOOP_DIRECTIVE = CursorKind(258, 'Omp_Task_Loop_Directive')

# OpenMP taskloop simd directive.
CursorKind.OMP_TASK_LOOP_SIMD_DIRECTIVE = CursorKind(259, 'Omp_Task_Loop_Simd_Directive')

# OpenMP distribute directive.
CursorKind.OMP_DISTRIBUTE_DIRECTIVE = CursorKind(260, 'Omp_Distribute_Directive')

# OpenMP target enter data directive.
CursorKind.OMP_TARGET_ENTER_DATA_DIRECTIVE = CursorKind(261, 'Omp_Target_Enter_Data_Directive')

# OpenMP target exit data directive.
CursorKind.OMP_TARGET_EXIT_DATA_DIRECTIVE = CursorKind(262, 'Omp_Target_Exit_Data_Directive')

# OpenMP target parallel directive.
CursorKind.OMP_TARGET_PARALLEL_DIRECTIVE = CursorKind(263, 'Omp_Target_Parallel_Directive')

# OpenMP target parallel for directive.
CursorKind.OMP_TARGET_PARALLELFOR_DIRECTIVE = CursorKind(264, 'Omp_Target_Parallelfor_Directive')

# OpenMP target update directive.
CursorKind.OMP_TARGET_UPDATE_DIRECTIVE = CursorKind(265, 'Omp_Target_Update_Directive')

# OpenMP distribute parallel for directive.
CursorKind.OMP_DISTRIBUTE_PARALLELFOR_DIRECTIVE = CursorKind(266, 'Omp_Distribute_Parallelfor_Directive')

# OpenMP distribute parallel for simd directive.
CursorKind.OMP_DISTRIBUTE_PARALLEL_FOR_SIMD_DIRECTIVE = CursorKind(267, 'Omp_Distribute_Parallel_For_Simd_Directive')

# OpenMP distribute simd directive.
CursorKind.OMP_DISTRIBUTE_SIMD_DIRECTIVE = CursorKind(268, 'Omp_Distribute_Simd_Directive')

# OpenMP target parallel for simd directive.
CursorKind.OMP_TARGET_PARALLEL_FOR_SIMD_DIRECTIVE = CursorKind(269, 'Omp_Target_Parallel_For_Simd_Directive')

# OpenMP target simd directive.
CursorKind.OMP_TARGET_SIMD_DIRECTIVE = CursorKind(270, 'Omp_Target_Simd_Directive')
...
CursorKind.UNEXPOSED_ATTR = CursorKind(400, 'Unexposed_Attr')

CursorKind.IB_ACTION_ATTR = CursorKind(401, 'Ib_Action_Attr')
CursorKind.IB_OUTLET_ATTR = CursorKind(402, 'Ib_Outlet_Attr')
CursorKind.IB_OUTLET_COLLECTION_ATTR = CursorKind(403, 'Ib_Outlet_Collection_Attr')

CursorKind.CXX_FINAL_ATTR = CursorKind(404, 'Cxx_Final_Attr')
CursorKind.CXX_OVERRIDE_ATTR = CursorKind(405, 'Cxx_Override_Attr')
CursorKind.ANNOTATE_ATTR = CursorKind(406, 'Annotate_Attr')
CursorKind.ASM_LABEL_ATTR = CursorKind(407, 'Asm_Label_Attr')
CursorKind.PACKED_ATTR = CursorKind(408, 'Packed_Attr')
CursorKind.PURE_ATTR = CursorKind(409, 'Pure_Attr')
CursorKind.CONST_ATTR = CursorKind(410, 'Const_Attr')
CursorKind.NODUPLICATE_ATTR = CursorKind(411, 'Noduplicate_Attr')
CursorKind.CUDACONSTANT_ATTR = CursorKind(412, 'Cudaconstant_Attr')
CursorKind.CUDADEVICE_ATTR = CursorKind(413, 'Cudadevice_Attr')
CursorKind.CUDAGLOBAL_ATTR = CursorKind(414, 'Cudaglobal_Attr')
CursorKind.CUDAHOST_ATTR = CursorKind(415, 'Cudahost_Attr')
CursorKind.CUDASHARED_ATTR = CursorKind(416, 'Cudashared_Attr')

CursorKind.VISIBILITY_ATTR = CursorKind(417, 'Visibility_Attr')

CursorKind.DLLEXPORT_ATTR = CursorKind(418, 'Dllexport_Attr')
CursorKind.DLLIMPORT_ATTR = CursorKind(419, 'Dllimport_Attr')
CursorKind.CONVERGENT_ATTR = CursorKind(438, 'Convergent_Attr')
CursorKind.WARN_UNUSED_ATTR = CursorKind(439, 'Warn_Unused_Attr')
CursorKind.WARN_UNUSED_RESULT_ATTR = CursorKind(440, 'Warn_Unused_Result_Attr')
CursorKind.ALIGNED_ATTR = CursorKind(441, 'Aligned_Attr')

###
# Preprocessing
CursorKind.PREPROCESSING_DIRECTIVE = CursorKind(500, 'Preprocessing_Directive')
CursorKind.MACRO_DEFINITION = CursorKind(501, 'Macro_Definition')
CursorKind.MACRO_INSTANTIATION = CursorKind(502, 'Macro_Instantiation')
CursorKind.INCLUSION_DIRECTIVE = CursorKind(503, 'Inclusion_Directive')

###
# Extra declaration

# A module import declaration.
CursorKind.MODULE_IMPORT_DECL = CursorKind(600, 'Module_Import_Decl')
# A type alias template declaration
CursorKind.TYPE_ALIAS_TEMPLATE_DECL = CursorKind(601, 'Type_Alias_Template_Decl')
...
class TranslationUnit(ClangObject):
    ...
    def from_source(cls, filename, args=None, unsaved_files=None, options=0,
        ...
        if not ptr:
            raise TranslationUnitLoadError(f'Error parsing translation unit {filename}')
...
def register_enumerations():
    for name, value in my_python_bindings.enumerations.TokenKinds:
